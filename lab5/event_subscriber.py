...
class EventSubscriber:
    ...
    def _events_match(self, published_event: dict, stored_event_data: dict) -> bool:
        ...
        return (
            published_event.get("aggregate_id") == stored_event_data.get("aggregate_id")
            and published_event.get("name") == stored_event_data.get("name")
            and published_event.get("email") == stored_event_data.get("email")
        )
